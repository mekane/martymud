...
sh_int  		gsn_whip;
/* MEK 3-13-2004
 * new weapon type / combat skills 
 */
sh_int  		gsn_staff;
sh_int			gsn_fourth_attack;
sh_int			gsn_dual_wield;

sh_int                  gsn_body_control;
sh_int                  gsn_trance;
...
void load_rooms( FILE *fp )
{
	...
	for ( ; ; )
	{
	   ...
	   else if ( letter == 'C') /* clan */
	   {
	     ...
	     /*MEK TEST*/bug("Load_rooms: vnum %d has clan field.",vnum);
		...
		/*MEK TEST*/bug("Load_rooms: vnum %d has owner field.",vnum);
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA *pMobIndex )
{
	...
	mob->dam_type		= pMobIndex->dam_type;
        if (mob->dam_type == 0)
            ...
            {
                case (1): mob->dam_type = DAM_BASH;   break; /* bash */
                case (2): mob->dam_type = DAM_PIERCE; break; /* pierce */ 
                case (3): mob->dam_type = DAM_SLASH;  break; /* slash */
            }
	for (i = 0; i < 4; i++)
