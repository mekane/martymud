...
const	struct	cmd_type	cmd_table	[] =
{
     ...
     */
    { "at",             do_at,          POS_DEAD,       L4,  LOG_NORMAL, 1 },
    ...
    { "goto",           do_goto,        POS_DEAD,       L5,  LOG_NORMAL, 1 },
...
/*  { "groups",		do_groups,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
    ...
    /*
     * MEK 3-11-2004
     * Added for remorting (ascending)
     */
    { "ascen",		do_ascen,	POS_DEAD,	0,  LOG_ALWAYS, 0 },
    { "ascend",		do_ascend,	POS_STANDING,	0,  LOG_ALWAYS, 1 },
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, */
     ...
     * For religions
     */
    { "worship",	do_worship,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "renounc",	do_renounc,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "renounce",	do_renounce,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
...
/*  { "sockets",	do_sockets,	POS_DEAD,	L4,  LOG_NORMAL, 1 }, */
    ...
    { "force",		do_force,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
...
/*  { "at",		do_at,		POS_DEAD,	L4,  LOG_NORMAL, 1 }, */
    ...
    { "gecho",		do_echo,	POS_DEAD,	L5,  LOG_ALWAYS, 1 },
/*  { "goto",		do_goto,	POS_DEAD,	L5,  LOG_NORMAL, 1 }, */
    ...
    { "penalty",	do_penalty,	POS_DEAD,	L5,  LOG_NORMAL, 1 },
    { "echo",		do_recho,	POS_DEAD,	L4,  LOG_ALWAYS, 1 },
    { "return",         do_return,      POS_DEAD,       L4,  LOG_NORMAL, 1 },
